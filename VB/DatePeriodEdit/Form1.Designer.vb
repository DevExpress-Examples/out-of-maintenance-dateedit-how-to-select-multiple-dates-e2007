Namespace DatePeriodEdit_NS
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			DirectCast(Me.repositoryItemDatePeriodEdit1, System.ComponentModel.ISupportInitialize).BeginInit()
			DirectCast(Me.repositoryItemDatePeriodEdit1.CalendarTimeProperties, System.ComponentModel.ISupportInitialize).BeginInit()
			DirectCast(Me.repositoryItemDatePeriodEdit2, System.ComponentModel.ISupportInitialize).BeginInit()
			DirectCast(Me.repositoryItemDatePeriodEdit2.CalendarTimeProperties, System.ComponentModel.ISupportInitialize).BeginInit()
			...
			Me.gridControl1.Size = New System.Drawing.Size(632, 422)
			...
			Me.repositoryItemDatePeriodEdit1.CalendarTimeProperties.Buttons.AddRange(New DevExpress.XtraEditors.Controls.EditorButton() { New DevExpress.XtraEditors.Controls.EditorButton()})
			Me.repositoryItemDatePeriodEdit1.Name = "repositoryItemDatePeriodEdit1"
			Me.repositoryItemDatePeriodEdit1.SelectionMode = DevExpress.XtraEditors.Repository.CalendarSelectionMode.Multiple
			Me.repositoryItemDatePeriodEdit1.ShowOk = DevExpress.Utils.DefaultBoolean.True
			...
			Me.repositoryItemDatePeriodEdit2.CalendarTimeProperties.Buttons.AddRange(New DevExpress.XtraEditors.Controls.EditorButton() { New DevExpress.XtraEditors.Controls.EditorButton()})
			Me.repositoryItemDatePeriodEdit2.Name = "repositoryItemDatePeriodEdit2"
			Me.repositoryItemDatePeriodEdit2.ShowOk = DevExpress.Utils.DefaultBoolean.True
...
'			Me.Load += New System.EventHandler(Me.Form1_Load)
			...
			DirectCast(Me.repositoryItemDatePeriodEdit1.CalendarTimeProperties, System.ComponentModel.ISupportInitialize).EndInit()
			DirectCast(Me.repositoryItemDatePeriodEdit1, System.ComponentModel.ISupportInitialize).EndInit()
			DirectCast(Me.repositoryItemDatePeriodEdit2.CalendarTimeProperties, System.ComponentModel.ISupportInitialize).EndInit()
			DirectCast(Me.repositoryItemDatePeriodEdit2, System.ComponentModel.ISupportInitialize).EndInit()
